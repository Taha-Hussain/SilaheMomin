...
public class ShabanMushtarekaAmalAdaptor extends ArrayAdapter<Dua> {

    Context context;

    public ShabanMushtarekaAmalAdaptor(Context _context, int resource, ArrayList<Dua> objects) {

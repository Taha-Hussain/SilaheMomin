...
public class RajabMushtarekaAmaltAdaptor extends ArrayAdapter<Dua> {

    Context context;

    public RajabMushtarekaAmaltAdaptor(Context _context, int resource, ArrayList<Dua> objects) {

...
public class RamzanMushtarekaAmalAdaptor extends ArrayAdapter<Dua> {

    Context context;

    public RamzanMushtarekaAmalAdaptor(Context _context, int resource, ArrayList<Dua> objects) {

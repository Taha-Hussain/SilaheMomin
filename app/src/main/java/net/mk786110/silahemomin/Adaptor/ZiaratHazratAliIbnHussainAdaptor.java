...
public class ZiaratHazratAliIbnHussainAdaptor extends ArrayAdapter<Dua> {

    Context context;

    public ZiaratHazratAliIbnHussainAdaptor(Context _context, int resource, ArrayList<Dua> objects) {

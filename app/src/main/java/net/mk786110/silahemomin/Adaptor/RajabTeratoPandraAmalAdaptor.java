...
public class RajabTeratoPandraAmalAdaptor extends ArrayAdapter<Dua> {

    Context context;

    public RajabTeratoPandraAmalAdaptor(Context _context, int resource, ArrayList<Dua> objects) {
